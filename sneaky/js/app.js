...
function replaceImg(id, id2) {
  randomNumber = makeRandomInt(50); // Can be 1 through 50
  randomNumber = (randomNumber*2)-1;
  randomNumberTwo = randomNumber + 1;

  id.src= stringMaker(randomNumber);
  id2.src= stringMaker(randomNumberTwo);
}

function replaceBoth() {
  replaceImg(img1, img2);
}
